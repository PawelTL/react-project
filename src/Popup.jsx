    ...
    return (
        <>
            {active ? <>
                ...
                <h2 className='absolute mx-[20vw] z-50 top-[22vh] text-center text-black font-semibold text-5xl md:text-8xl w-[60vw]'>{win ? "You win!" : loss ? "You lose!" : "Welcome!"}</h2>
                ...
                <button type='button' onClick={handleResetButton} className='hover:bg-slate-800 duration-300 hover:scale-105 absolute md:top-[50vh] mx-[32.5vw] top-[60vh] md:mx-[40vw] w-[35vw] h-[14vw] bg-slate-700 md:w-[20vw] md:h-[8vw] text-white rounded-3xl border-4 border-black text-2xl md:text-4xl font-bold'>{win || loss ? "Try Again" : "Start"}</button>
            </> : null
            }
