    ...
    return (
        <div className='flex justify-center w-screen h-screen p-16 bg-slate-700'>
            ...
            <div className='absolute top-[40vh] text-xl md:text-2xl mx-[10vw] md:mx-[25vw] flex flex-wrap justify-center '>
                ...
                <Link to={"/game"} state={{search: search, highScore: state[2]}}><div className='bg-slate-400 m-20 border-2 border-black w-[20vw] h-[8vw] rounded-3xl text-5xl flex justify-center items-center font-bold'>{state[1] || state[2] ? "Try again" : "Begin"}</div></Link>
            </div>
        </div>
    )
}
